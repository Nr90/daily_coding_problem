...
function count_attacking_bishops(M::Int, bishops::Array{Tuple{Int, Int},1})
    board = zeros(Int, M, M)
    for b in bishops
        board[b[1], b[2]] = 1
    end
...
@test count_attacking_bishops(M, b) == 2
...
@test count_attacking_bishops(M, b) == 4
